...
{$ENDIF}
  ...
  frxRich, 
  frxOLE, frxBarCode,
  frxChBox, frxDMPExport, frxListBox, frxComboBox,
{$IFNDEF FR_VER_BASIC}
  frxDCtrl, 
{$ENDIF}
{$IFNDEF RAD_ED}
  frxGaugePanel, frxCross, frxGaugeView, frxTableObject, frxMap, frxCellularTextObject, frxZipCode,
{$ENDIF}
{$IFNDEF WIN64}
 frxRichEdit, 
{$ENDIF}
...
{$IFNDEF FPC}
{$IFDEF Delphi9}
   SplashScreenServices.AddPluginBitmap('FastReport VCL',
...
{$ENDIF}
{$IFNDEF RAD_ED}
     TfrxGaugePanel, TfrxIntervalGaugePanel, TfrxCrossObject, TfrxGaugeObject, TfrxReportTableObject, TfrxMapObject, TfrxReportCellularTextObject, TfrxZipCodeObject,
{$ENDIF}
     TfrxCheckBoxObject, TfrxGradientObject,
     TfrxDotMatrixExport, TfrxListBoxObject, TfrxComboBoxObject
{$IFNDEF FR_VER_BASIC}
   , TfrxDialogControls
{$ENDIF}
   , TfrxGZipCompressor
...
{$ELSE}
  RegisterComponents('FastReport VCL',[
    ...
    TfrxCrossObject, TfrxGaugeObject, TfrxReportTableObject, TfrxReportCellularTextObject,
     TfrxMapObject, TfrxCheckBoxObject, TfrxGradientObject, TfrxDotMatrixExport,
     TfrxDialogControls, TfrxGZipCompressor, TfrxCrypt 
    ]);
{$ENDIF}
  RegisterComponents('FastReport VCL Tools',
    [TfrxDockSite, TfrxTBPanel, TfrxComboEdit,
     TfrxComboBox, TfrxFontComboBox, TfrxRuler, TfrxScrollBox, TfrxColorComboBox, TfrxDockToolBar]);
