...
begin
  ...
  try
    ...
    try
      ...
      Writer.WriteRootComponent(aTable, True, aRoot);
      wr.AutoIndent := False;
...
finalization
  frxUnregisterEditorsClass(TfrxTableRow, TfrxRowColumnCopyPasteEditor);
  frxUnregisterEditorsClass(TfrxTableColumn, TfrxRowColumnCopyPasteEditor);
  frxUnregisterEditorsClass(TfrxTableCell, TfrxInPlaceMemoCopyPasteEditor);
end.
