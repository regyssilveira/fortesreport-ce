...
{$ENDIF}
  ...
  frxAnaliticGeometry, frxPolygonTemplate, frxBaseForm;
...
{$EndIf}
  ...
  TfrxMapILEditorForm = class(TfrxBaseForm)
    btnCancel: TButton;
    btnOk: TButton;
...
procedure TfrxMapILEditorForm.UpdateFormPPI(aNewPPI: Integer);
begin
  inherited;
  Translate(Self);
end;

procedure TfrxMapILEditorForm.UpdateResouces;
begin
  inherited;
