...
{$IFDEF DELPHI16}
/// <summary>
///   The TfrxGradientObject allows the use of the Gradient component in your
///   report. TfrxGradientObject is an empty component. It is used to add the
///   frxGradient.pas file to the "uses" list. The main component is
///   TfrxGradientView.
/// </summary>
...
{$ENDIF}
  ...
  /// <summary>
  ///   The TfrxGradientView component represents a gradient fill. Deprecated,
  ///   use Object.Fill instead of TfrxGradientView.
  /// </summary>
