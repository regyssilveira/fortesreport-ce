...
TfrxBarcodeDataMatrix = class( TfrxBarcode2DBaseWithUnion )
  ...
  private
    ...
    function C40OrTextEncodation(var Text: array of byte; textOffset, textLength: Integer; var data: array of byte; dataOffset, dataLength: Integer; C40 : boolean ): Integer;
...
procedure TfrxBarcodeDataMatrix.MakePadding(var data : array of byte; position, count : integer);
var
    t : integer;
begin
  // set to ascii mode
  if (count > 0) and (position > 0) and not FIsLastEncodingAscii then
  begin
...
function TfrxBarcodeDataMatrix.AsciiEncodation( var text : array of byte; textOffset, textLength : integer; var data : array of byte; dataOffset, dataLength : integer )  : integer;
var
...
function TfrxBarcodeDataMatrix.B256Encodation(var text : array of byte; textOffset, textLength : integer; var data : array of byte; dataOffset, dataLength : integer ) : integer;
var
    k, j, prn, tv, c : integer;
begin
    if textLength = 0 then begin result := 0; exit; end;
    FIsLastEncodingAscii := False;
...
function TfrxBarcodeDataMatrix.X12Encodation(var text: array of byte; textOffset, textLength : integer; var data : array of byte; dataOffset, dataLength : integer ) : integer;
var
...
function TfrxBarcodeDataMatrix.EdifactEncodation(var text: array of byte; textOffset, textLength: integer; var data: array of byte; dataOffset, dataLength: integer): integer;
var
...
function TfrxBarcodeDataMatrix.C40OrTextEncodation(var Text : array of byte; textOffset, textLength : integer; var data : array of byte; dataOffset, dataLength : integer;
                             C40 : boolean ) : integer;
var
