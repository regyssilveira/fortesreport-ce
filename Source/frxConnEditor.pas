...
uses
  ...
  ComCtrls, StdCtrls, Buttons, ExtCtrls, frxClass, frxConnItemEdit, frxBaseForm
  {$IFDEF FPC}
  , LCLType
  {$ENDIF}
{$IFDEF FR_FIB}
...
type
  TfrxConnEditorForm = class(TfrxBaseForm)
    NewB: TButton;
    DeleteB: TButton;
    ConnLV: TListView;
    OKB: TButton;
...
procedure TfrxConnEditorForm.UpdateResouces;
begin
  inherited;
  Caption := frxGet(5800);
