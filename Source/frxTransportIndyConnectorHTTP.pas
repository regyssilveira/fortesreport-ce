...
{$ENDIF}
  ...
  procedure frxTestTokenIndy(const URL: String; var sToken: String;
    bUsePOST: Boolean; PrefixAut: String = 'Bearer ');
...
{$ENDIF}
    IdHTTP.Request.CustomHeaders.Values['Authorization'] := PrefixAut +
      sToken;
