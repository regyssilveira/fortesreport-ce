...
begin
  ...
  with AScript do
  begin
    AddEnum('TfrxBarcode2DType', 'bcCodePDF417, bcCodeDataMatrix, bcCodeQR, bcCodeAztec, bcCodeMaxiCode, bcGS1DatabarE, bcGS1DatabarES, bcPharmacodeTT');
    ...
    AddClass(TfrxGS1DatabarEProperties, 'TfrxBarcode2DProperties');
    AddClass(TfrxGS1DatabarESProperties, 'TfrxBarcode2DProperties');
