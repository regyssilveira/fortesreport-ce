...
type
  TfrxNewItemForm = class(TfrxBaseForm)
    Pages: TPageControl;
    ItemsTab: TTabSheet;
    OkB: TButton;
    CancelB: TButton;
...
procedure TfrxNewItemForm.UpdateFormPPI(aNewPPI: Integer);
begin
  inherited;
...
procedure TfrxNewItemForm.UpdateResouces;
begin
  inherited;
  Caption := frxGet(5300);
