...
uses
  ...
  StdCtrls, extctrls, frxClass, IniFiles, ComCtrls, frxIOSMTP, frxBaseForm
...
type
  ...
  TfrxMailIOTransportForm = class(TfrxBaseForm)
    OkB: TButton;
    CancelB: TButton;
...
procedure TfrxMailIOTransportForm.UpdateResouces;
begin
  inherited;
  Caption := frxGet(8900);
