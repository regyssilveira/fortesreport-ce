...
uses
  ...
  Dialogs, StdCtrls, ExtCtrls, Buttons, frxBaseForm,
...
(******************************************************************************)
  TMapColorRangeForm = class(TfrxBaseForm)
...
procedure TMapColorRangeForm.UpdateFormPPI(aNewPPI: Integer);
begin
  inherited;
...
procedure TMapColorRangeForm.UpdateResouces;
begin
  inherited;
  Translate(Self);
end;
...
begin
  ...
  Top := TitleHeight + ValuesHeight {$IFDEF FRX_USE_BITMAP_MAP} + OfsetY {$ENDIF};
