...
{$ELSE}
  /// <summary>
  ///   The TfrxDMPMemoView is similar to TfrxMemoView, but is intended for
  ///   dot-matrix mode.
  /// </summary>
...
{$ENDIF}
  ...
  published
    ...
    property WordWrap;
    /// <summary>
    ///   It is used for cutting a text exceeding the bounds of objects if
    ///   words transfer function is switched off.
    /// </summary>
...
{$ELSE}
  /// <summary>
  ///   The TfrxDMPLineView is similar to TfrxLineView, but is intended for
  ///   dot-matrix mode.
  /// </summary>
...
{$ELSE}
  /// <summary>
  ///   The TfrxDMPCommand component can execute an ESC command in the
  ///   dot-matrix mode.
  /// </summary>
...
{$ENDIF}
  ...
  published
    /// <summary>
    ///   The ESC command. You can use two formats of command: 1B40 or #27#64.
    /// </summary>
...
{$ELSE}
  /// <summary>
  ///   The TfrxDMPPage is similar to TfrxReportPage, but is intended for
  ///   dot-matrix mode.
  /// </summary>
