...
type
  ...
  /// </code>
  /// </example>
    TfrxBarcodePDF417 = class(TfrxBarcode2DBaseWithUnion)
...
{$ENDIF}
  ...
  PaintCode();
  //pnly PDF417 array of byte -> array of array of boolean
  SetLength(arrOB, FWidth, FHeight);
  ...
  SetLength(FImage, 0);
  T2DBooleanArrayToVectorPrimitives(arrOB, FWidth, FHeight);
end;
