...
type
  TUnicodeEdit = class(TEdit)
  private
    procedure frxSetSelText(const Value: WideString);
  ...
  public
    property SelText: WideString read GetSelText write frxSetSelText;
...
procedure TUnicodeEdit.frxSetSelText(const Value: WideString);
begin
