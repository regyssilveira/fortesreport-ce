...
function DoublePoint(P: TPoint): TDoublePoint; overload;
...
function DoubleRect(R: TfrxRect): TDoubleRect; overload;
...
function RectWidth(R: TfrxRect): Extended; overload;
function RectWidth(R: TRect): Integer; overload;
